...
const Doctors = () => {
  ...
  const [columnDefs, setColumnDefs] = useState<ColDef[]>([
    ...
    },
    {
      ...
      field: "doctor_practice_profession",
    },
    {
  ...
  const fetchImage = async (id: any) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(
        `${baseUrl}/doctors/profile-image/${token}/${id}`,
        {
          method: "GET",
        }
      );
  ...
  const handleToggle = async (data: any) => {
    ...
    try {
      ...
      console.log(status);
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BASE_URL}/doctors/update-doctor-status/${status}/${data.id}/${token}`,
        {
          method: "GET",
        }
      );
...
// }
  ...
  const handleAddSubject = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BASE_URL}/doctors/add`,
        {
          method: "POST",
          body: form,
        }
  ...
  const handleUpdateSubject = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BASE_URL}/doctors/update-doctor`,
        {
          method: "POST",
          body: form,
        }
